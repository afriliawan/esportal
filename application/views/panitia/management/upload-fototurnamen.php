        ...
        $foto_turnamen 		= $datauploadfotoTurnamen->fotoTurnamen;
}else{
        $id_turnamen 	    = "";
        $nama_turnamen 		= "";
        $foto_turnamen 		= "";
                ...
                <?= form_open_multipart('management/formuploadfotoTurnamen/'.$id); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                        <div class="col-sm-3">
                                <img src="<?= base_url('/android/images/turnamen/') . $foto_turnamen; ?>" class="img-thumbnail">
                            </div>
                            <div class="col-sm-11">
