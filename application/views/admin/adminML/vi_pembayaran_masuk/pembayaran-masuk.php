                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <center>
                                  <input type="hidden" class="form-control" name="is_active" value='2'><a href="<?= base_url('adminML/acceptRegis/'.$r['idTurnamen']) ?>" class="badge badge-success">Accept</a> ||
                                    <a href="<?= base_url('adminML/deleteRegis/'.$r['idTurnamen']) ?>" onclick="return confirm('Tolak permintaan ini?')" class="badge badge-danger">Reject</a>
                            </center>
                        </td>
                      </tr>
                    <?php } ?>
