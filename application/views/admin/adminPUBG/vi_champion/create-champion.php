        ...
        <div class="row">
            ...
            <!--<form action="">-->
                ...
                <?= form_open_multipart('adminPUBG/formcreateChampion'); ?>
                <div class="form-group row">
                    ...
                    <div class="class col-sm-8">
                        ...
                        <input type="hidden" class="form-control" name="idGame" value='1'>                                 
                ...
                <div class="form-group row justify-content-end">
                    <div class="col-sm-8">
                        <a href="<?= site_url('adminPUBG/champion') ?>" class="btn btn-primary" >Kembali</a>
